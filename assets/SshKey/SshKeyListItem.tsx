...
import { useArchiveSshKeyMutation } from './SshKeyData';
import SshKeyListItemEditor from './SshKeyListItemEditor';
...
const SshKeyListItem = (
    ...
    const archiveMutation = useArchiveSshKeyMutation(item.id, isArchive);
