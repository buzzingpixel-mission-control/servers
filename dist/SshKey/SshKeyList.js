...
var SshKeyListItem_1 = __importDefault(require("./SshKeyListItem"));
function classNames() {
    var classes = [];
...
var SshKeyList = function (_a) {
    ...
    var archiveSelectedMutation = (0, SshKeyData_1.useArchiveSelectedSshKeysMutation)(items.filter(function (i) { return selectedItems.indexOf(i.id) > -1; }), isArchive);
    if (items.length < 1) {
        return (react_1.default.createElement(buzzingpixel_mission_control_frontend_core_1.NoResultsAddItem, { icon: react_1.default.createElement(solid_1.KeyIcon, null), headline: "No Keys match your filters" }));
    }
    ...
    var withSelectedOpacity = withSelectedDisabled
        ? 'opacity-40'
        : 'opacity-100';
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement("div", { className: "bg-white rounded-md shadow-sm" },
            react_1.default.createElement("ul", { className: "divide-y divide-gray-100" }, items.map(function (item) { return (react_1.default.createElement(SshKeyListItem_1.default, { key: item.id, isArchive: isArchive, item: item, selectedItemsManager: selectedItemsManager })); })))));
};
exports.default = SshKeyList;
