...
var SshKeyDetailsPage = function () {
    ...
    (0, buzzingpixel_mission_control_frontend_core_1.useBreadcrumbs)([
        ...
        {
            name: pageNameState,
            href: "/ssh-keys/".concat(slug),
        },
    ]);
    var _c = (0, SshKeyDetailsData_1.useSshKeyDetailsData)(slug), status = _c.status, data = _c.data;
    if (status === 'loading') {
        return react_1.default.createElement(buzzingpixel_mission_control_frontend_core_1.PartialPageLoading, null);
    }
    var pageName = "SSH Key: ".concat(data.title);
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(Details_1.default, { data: data })));
};
exports.default = SshKeyDetailsPage;
