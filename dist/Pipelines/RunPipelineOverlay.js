...
var RunPipelineOverlay = function (_a) {
    var isOpen = _a.isOpen, setIsOpen = _a.setIsOpen, heading = _a.heading, message = _a.message;
    return (react_1.default.createElement(react_2.Transition.Root, { show: isOpen, as: react_1.Fragment },
        react_1.default.createElement(react_2.Dialog, { as: "div", className: "relative z-50", onClose: setIsOpen },
            ...
            react_1.default.createElement("div", { className: "fixed inset-0 z-50 w-screen overflow-y-auto" },
                    ...
                    react_1.default.createElement(react_2.Transition.Child, { as: react_1.Fragment, enter: "ease-out duration-300", enterFrom: "opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95", enterTo: "opacity-100 translate-y-0 sm:scale-100", leave: "ease-in duration-200", leaveFrom: "opacity-100 translate-y-0 sm:scale-100", leaveTo: "opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" },
                        react_1.default.createElement(react_2.Dialog.Panel, { className: "relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6" },
                            react_1.default.createElement("div", { className: "sm:flex sm:items-start" },
                                react_1.default.createElement("div", { className: "mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-cyan-100 sm:mx-0 sm:h-10 sm:w-10" },
                                    react_1.default.createElement(outline_1.RectangleGroupIcon, { className: "h-6 w-6 text-cyan-600", "aria-hidden": "true" })),
                                react_1.default.createElement("div", { className: "mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left" }, (function () {
                                    if (heading) {
                                        return (react_1.default.createElement(react_1.default.Fragment, null,
                                            react_1.default.createElement(react_2.Dialog.Title, { as: "h3", className: "text-base font-semibold leading-6 text-gray-900" }, heading),
                                            react_1.default.createElement("div", { className: "mt-2" },
                                                react_1.default.createElement("p", { className: "text-sm text-gray-500" }, message))));
                                    }
                                    return (react_1.default.createElement("p", { className: "text-sm text-gray-500" }, message));
                                })())),
...
exports.default = RunPipelineOverlay;
