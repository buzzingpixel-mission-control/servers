...
var Page = function () {
    ...
    var _a = (0, react_1.useState)('Loading Pipeline Details…'), pageNameState = _a[0], setPageNameState = _a[1];
    ...
    var _c = (0, PipelineDetailsData_1.usePipelineDetailsData)(slug), status = _c.status, data = _c.data;
    if (status === 'loading') {
