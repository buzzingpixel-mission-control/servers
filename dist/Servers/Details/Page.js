...
var ServerDetailsData_1 = require("./ServerDetailsData");
...
var Page = function () {
    ...
    var _a = (0, react_1.useState)('Loading Server Details…'), pageNameState = _a[0], setPageNameState = _a[1];
    ...
    var _c = (0, ServerDetailsData_1.useServerDetailsData)(slug), status = _c.status, data = _c.data;
    if (status === 'loading') {
        return react_1.default.createElement(buzzingpixel_mission_control_frontend_core_1.PartialPageLoading, null);
    }
    var pageName = "Server: ".concat(data.title);
