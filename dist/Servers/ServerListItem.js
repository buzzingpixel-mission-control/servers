...
var ServerListItemEditor_1 = __importDefault(require("./ServerListItemEditor"));
function classNames() {
    var classes = [];
...
var ServerListItem = function (_a) {
    ...
    var archiveMutation = (0, ServerData_1.useArchiveServerMutation)(item.id, isArchive, item.projectId);
    ...
    return (react_1.default.createElement("li", { className: "px-4".concat(selectedClasses) },
            ...
            react_1.default.createElement("div", { className: "min-w-0" },
                ...
                react_1.default.createElement("div", { className: "mt-1 flex items-center gap-x-2 text-xs leading-5 text-gray-500 truncate" },
                    react_1.default.createElement("p", null,
                        "Address:",
                        ' ',
                        react_1.default.createElement("strong", null, item.address)))),
        ...
        (function () {
            ...
            return (react_1.default.createElement(ServerListItemEditor_1.default, { item: item, setEditorIsOpen: setEditIsOpen }));
        })()));
};
...
exports.default = ServerListItem;
